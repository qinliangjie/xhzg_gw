...
$('.gotonav').on('click', function(e) {
    if (switchs == 0) {
       $(".nav").css("z-index", "99");
        ...
        $(".nav").css("background", "url(/mobile/images/dise.png) no-repeat");
        $("html").css("overflow", "hidden");
        $(this).next().addClass("active animated fadeInRight");
        $(this).attr("src", "/mobile/images/X.png")
        switchs = 1
    } else {
        $("html").css("overflow", "auto");
        $(".nav").css("z-index", "9");
        $(".nav").css("background", "url(/mobile/images/tops.png) no-repeat");
        $(this).next().removeClass("active animated fadeInRight").addClass("active animated fadeOutRight");
        $(this).attr("src", "/mobile/images/detail.png")
        switchs = 0
    }
...
var changTotal = function(e,ts){
  ...
  $("#totalImg").attr("src","/mobile/images/"+srcs+".png")
...
$(".boxJ").on("click",function(){
    if ($(this).hasClass("activeJ")){
      ...
      if($(".activeJ")){
        ...
        $(".jewleContent").attr("src","/mobile/images/jewel/"+source+".png");
    }
});